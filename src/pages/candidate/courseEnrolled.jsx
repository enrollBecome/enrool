  ...
  return (
   ...
   <OnboardingTopbar />
      <div className="w-full  lg:rounded-[60px] lg:p-[60px] mt-[20px] flex-col bg-white h-fit ">
                ...
                <div class=" bg-[#bc9c22] text-white mt-4 py-10 rounded-[30px]">
        <div class="container mx-auto text-center">
            <h1 class="text-4xl font-bold">The Becoming Institute</h1>
            <h2 class="text-2xl mt-2 seasons">12-Month Trauma Recovery Certificate Program</h2>
        </div>
    </div>

    <div class="container mx-auto px-4 py-8">
        <section id="program-overview" class="mb-8">
            <h3 class="text-2xl font-semibold mb-4">Program Overview</h3>
            <p class="mb-4">
        ...
        <section id="program-structure" class="mb-8">
        ...
        <section id="learning-approach" class="mb-8">
            <h3 class="text-2xl font-semibold mb-4">Learning Approach</h3>
            <p class="mb-4">
