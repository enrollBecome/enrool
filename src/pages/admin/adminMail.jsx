...
console.log(subject) 
  ...
  >
    ...
    <div className="flex-1 text-left w-1/3">
      <p className="font-semibold text-gray-700 truncate">{ami.subject}</p>
      {ami && ami.instructor_name?(<><p className="text-gray-500  text-left truncate">{ami.query}</p></>):null}
    </div>

    {/* Query */}
    {ami && ami.instructor_name?( <div className="flex-1 text-left w-1/3">
    <p className="text-gray-500 truncate">{ami.instructor_name}</p>
    </div>):(<div className="flex-1 text-left w-1/3"><p className="text-gray-500  text-left truncate">{ami.query}</p></div>)}
