import {   getApplicationByIdPrrmail } from "@/api/apiApplication";
...
import { z } from "zod";
const prrFormSchema = z.object({
    applicant_name: z.string().min(1, "Name is required"),
    email: z.string().email("Invalid email address"),
  application_id:z.string().min(1, "Application id is required"),
  category:z.string(),
  status:z.enum(RefrenceStatus, { errorMap: () => ({ message: "Status must not be empty" }) }),
  });
const ViewPrrApplication = () => {
  ...
  const {
    ...
    resolver: zodResolver(prrFormSchema),
    defaultValues: {
      applicant_name: formData?.applicant_name || "",
      email: formData?.prremail || "",
...
//   Professional Reference
  useEffect(() => {
    ...
    if(formData.prremail){
    const applicationid = formData.application_id;
    
    getApplicationByIdPrrmail(applicationid,formData.prremail)
...
//   Fetch Experience
  useEffect(() => {
   ...
   return (
    <>
      {application && application.prr_email===String(formData?.prremail) ? (
            ...
            <div className="border-t mt-4 pt-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="mb-2 text-2xl ">{application.gender}</span>
                </div>
                <div className="flex flex-col">
                  <span className="mb-2 text-gray-500 text-[13px] poppins-regular">
                    Date of Birth
                ...
                <div className="flex flex-col">
                  ...
                  <span className="mb-2 text-2xl ">{application.phone}</span>
                </div>
                <div className="flex flex-col">
                  <span className="mb-2 text-gray-500 text-[13px] poppins-regular">
                    Country of Residence
                  </span>
                  <span className="mb-2 text-2xl ">{application.country}</span>
                </div>
              </div>
            </div>
            {/* Education & Language  */}
            ...
            <div className="border-t mt-4 pt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="mb-2 text-2xl ">{application.ancestry}</span>
                </div>
              </div>
            </div>
            {/* Term Selection  */}
                        ...
                        >
                          <div className=" grid grid-cols-2 md:grid-cols-3 gap-4  w-11/12">
                            ...
                            <div className="flex flex-col">
                              ...
                              <p className="mb-2 text-2xl ">{educate.city}</p>
                            </div>
                            <div className="flex flex-col">
                              <p className="text-sm font-light text-gray-400">
                                Completed
                        ...
                        >
                          <div className=" grid grid-cols-2 md:grid-cols-3 gap-4  w-11/12">
                            ...
                            <div className="flex flex-col">
                              ...
                              <p className="mb-2 text-2xl ">{educate.title}</p>
                            </div>
            ...
            <div className="border-t mt-4 pt-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                <div className="flex flex-col">
                  ...
                  <span className="mb-2 text-2xl ">{application.ar_name}</span>
                </div>
                <div className="flex flex-col">
                  <span className="mb-2 text-gray-500 text-[13px] poppins-regular">
                    Phone Number
                  </span>
                  <span className="mb-2 text-2xl ">{application.ar_phone}</span>
                </div>
                <div className="flex flex-col">
                  <span className="mb-2 text-gray-500 text-[13px] poppins-regular">
                    Email Address
                  </span>
                  <span className="mb-2 text-2xl ">{application.ar_email}</span>
                </div>
              </div>
            </div>
            ...
            <div className="border-t mt-4 pt-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                <div className="flex flex-col">
                  ...
                  <span className="mb-2 text-2xl ">{application.prr_name}</span>
                </div>
                <div className="flex flex-col">
                  <span className="mb-2 text-gray-500 text-[13px] poppins-regular">
                    Phone Number
            ...
            <div className="border-t mt-4 pt-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                <div className="flex flex-col">
                  ...
                  <span className="mb-2 text-2xl ">{application.per_name}</span>
                </div>
                <div className="flex flex-col">
                  <span className="mb-2 text-gray-500 text-[13px] poppins-regular">
                    Phone Number
            ...
            <div className="border-t mt-4 pt-8">
              ...
              <div className="mt-4">
                <span className="text-gray-400">
                  ...
                  authorize Becoming Institute’s Admissions Committee to access
                  the information, contact my reference if required and evaluate
                  my admissibility to the 12-month Trauma Recovery program.
                </span>
              </div>
              ...
              <div className="mt-4">
                <span className="text-gray-400">
                  ...
                  require changes to your information after your application has
                  been submitted, notify info@becomingmethod.com. If you find
                  any errors above, please go back to make the changes
                  necessary.
                </span>
              </div>
            </div>
...
export default ViewPrrApplication;
