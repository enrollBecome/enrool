...
const formSchema = z.object({
  ...
  peremail: z.string().email("Invalid email address"),
application_id:z.string().min(1, "Application id is required"),
});

const PersonalRefrence = () => {
  ...
  const onSubmit = (data) => {
    ...
    navigate("/view-per-application", { state: { formData: data } });
  };
...
export default PersonalRefrence