import {  getApplicationByIdPermail } from "@/api/apiApplication";
...
//   Personal Refrence
  useEffect(() => {
    ...
    if(formData.peremail){
    const applicationid = formData.application_id;
    
    getApplicationByIdPermail(applicationid,formData.peremail)
...
//   Fetch Experience
  useEffect(() => {
   ...
   return (
    <>
      {application && application.per_email===String(formData?.peremail) ? (
...
export default ViewPerApplication;
