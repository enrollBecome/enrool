...
const formSchema = z.object({
  ...
  aremail: z.string().email("Invalid email address"),
application_id:z.string().min(1, "Application id is required"),
});

const AcademicRefernce = () => {
  ...
  const onSubmit = (data) => {
    ...
    navigate("/view-ar-application", { state: { formData: data } });
  };
...
export default AcademicRefernce